        ...
        <CardContent className="p-0">
          <div className="overflow-x-auto">
            <Table className="min-w-[980px]">
              ...
              <TableBody>
                {paginated.length === 0 ? (
                  <TableRow><TableCell colSpan={10} className="py-16 text-center text-muted-foreground text-sm">No users match your filters.</TableCell></TableRow>
                ) : paginated.map((l, i) => (
                    ...
                    <TableCell className="text-right pr-4">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-40">
                          <DropdownMenuItem className="text-sm gap-2 cursor-pointer"><Eye className="h-3.5 w-3.5" />View User</DropdownMenuItem>
                          <Link to="/leads/edit-leads">
                            <DropdownMenuItem className="text-sm gap-2 cursor-pointer"><Pencil className="h-3.5 w-3.5" />Edit User</DropdownMenuItem>
                          </Link>
